...
static var card_database = {
	...
	"wooden_spear": {
		...
		"weapon_attack_sound": {"name": "spear_thrust", "volume_db": 0.0},
		"card_type": "equipment",
		"slot": "weapon",
		"weapon_type": "melee",
		"melee_type": "lunge",
	...
	"bow": {
		...
		"projectile_sound": {"name": "arrow", "volume_db": 0.0},
	...
	"iron_sword": {
		...
		"polygon_offset": Vector2(-1, -17),
		"weapon_scale": Vector2(2, 2),
		"weapon_attack_sound": {"name": "sword_slash", "volume_db": 0.0},
		"card_type": "equipment",
		"slot": "weapon",
		"weapon_type": "melee",
		"melee_type": "slash",
	...
	"wolf": {
		...
		"weapons": [
			...
			},
			{
				...
				"polygon_offset": Vector2(-1,-17),
				"weapon_scale": Vector2(2,2),
				"weapon_attack_sound": {"name": "claw_slash", "volume_db": 0.0},
				"slot": "weapon",
				"weapon_type": "melee",
				"melee_type": "slash",
				"weapon_stats": {"add": {"attack": 1, "attack_range": 150, "attack_speed": 0.75}},
